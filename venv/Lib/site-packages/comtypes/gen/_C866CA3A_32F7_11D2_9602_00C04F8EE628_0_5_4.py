...
__all__ = [
    'SAFTCCITT_ALaw_8kHzStereo', 'SPPS_Noun', 'SVP_14',
    'SPAO_RETAIN_AUDIO', 'eLEXTYPE_PRIVATE10',
    'DISPID_SRCEPropertyStringChange', 'ISpMMSysAudio',
    'ISpeechAudioFormat', 'SpSharedRecoContext',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SPIRule',
    'SAFT22kHz8BitStereo', 'SPSERIALIZEDPHRASE',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SpShortcut', 'SBONone',
    'SpeechRetainedAudioOptions', 'SPEI_MAX_SR',
    'DISPID_SVSLastStreamNumberQueued', 'SPSMF_UPS',
    'DISPID_SRRRecoContext', 'SpeechCategoryAudioOut',
    'DISPID_SRRDiscardResultInfo', 'SpPhoneticAlphabetConverter',
    'STCAll', 'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SVVoice',
    'DISPID_SRRGetXMLResult', '_ISpeechVoiceEvents',
    'SpeechPropertyAdaptationOn', 'SpeechTokenKeyFiles',
    'DISPID_SVAudioOutputStream', 'DISPID_SpeechPhraseReplacements',
    'ISpeechVoiceStatus', 'ISpeechMMSysAudio', 'ISpRecognizer3',
    'ISpeechPhraseElement', 'DISPID_SVEBookmark',
    'SRSInactiveWithPurge', 'SDKLCurrentUser',
    'DISPID_SGRSTPropertyId', 'DISPID_SPEsItem',
    'DISPID_SRIsUISupported', 'SpeechVoiceSpeakFlags',
    'SpeechMicTraining', 'SPINTERFERENCE_NOSIGNAL', 'SRTAutopause',
    'SPPHRASEELEMENT', 'DISPID_SRGDictationUnload', 'SPPS_Unknown',
    'ISpeechGrammarRule', 'eLEXTYPE_PRIVATE6', 'DISPID_SPPs_NewEnum',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SAEventHandle',
    'eLEXTYPE_PRIVATE12', 'DISPID_SPRuleName', 'SREPrivate',
    'SPVPRI_NORMAL', 'SPEVENTENUM', 'DISPID_SGRsItem',
    'DISPID_SDKEnumKeys',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPEI_TTS_PRIVATE', 'ISpNotifySource', 'DISPID_SPRs_NewEnum',
    'DISPID_SRSetPropertyString', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SGRSAddWordTransition', 'SPEI_SR_PRIVATE', 'ISpPhrase',
    'SPSLMA', 'SPRST_ACTIVE', 'SP_VISEME_16',
    'DISPID_SpeechFileStream', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SPIAudioStreamPosition', 'SRAONone',
    'DISPID_SVGetAudioOutputs', 'ISpNotifyTranslator',
    'SAFTADPCM_8kHzStereo', 'DISPID_SASetState', 'ISpeechAudioStatus',
    'SDTAlternates', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SpeechObjectTokens', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SDKDeleteKey', 'DISPID_SRCreateRecoContext',
    'DISPID_SVVolume', 'SAFTADPCM_44kHzMono', 'SVEPhoneme',
    'SVF_None', 'SpeechCategoryPhoneConverters',
    'DISPID_SRGCmdLoadFromMemory', 'SpInprocRecognizer',
    'DISPID_SAFGuid', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SAFGetWaveFormatEx', 'SAFT11kHz16BitMono',
    'eLEXTYPE_PRIVATE20', 'SPEI_RESERVED3', 'DISPID_SGRSTText',
    'SVSFlagsAsync', 'SAFT44kHz8BitMono', 'DISPID_SAFSetWaveFormatEx',
    'SRARoot', 'DISPID_SGRSTPropertyName', 'SPEI_SR_BOOKMARK',
    'SVP_13', 'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SFSOpen',
    'SPVPRI_ALERT', 'DISPID_SRGetPropertyNumber',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SpeechPhraseRules',
    'SSSPTRelativeToCurrentPosition', 'SpeechTokenKeyUI',
    'SAFTCCITT_uLaw_22kHzMono', 'SPCS_DISABLED',
    'DISPID_SpeechObjectToken', 'ISpPhoneConverter',
    'DISPID_SPEAudioSizeBytes', 'SPGS_EXCLUSIVE', 'SpeechLoadOption',
    'DISPID_SPERetainedSizeBytes', 'SPEVENT', 'SPPS_RESERVED3',
    'DISPID_SBSWrite', 'DISPID_SPAsItem', 'SRTStandard',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SRCEAdaptation',
    'SpeechPropertyNormalConfidenceThreshold', 'IEnumSpObjectTokens',
    'SPBO_AHEAD', 'DISPIDSPTSI', 'DISPID_SLPsItem',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SPCPhoneToId',
    'DISPID_SPEActualConfidence', 'SpeechPartOfSpeech',
    'SSTTWildcard', 'ISpProperties', 'ISpeechObjectTokenCategory',
    'SPAUDIOBUFFERINFO', 'SREPropertyStringChange',
    'SPDKL_LocalMachine', 'STSF_CommonAppData', 'SpMMAudioIn',
    'WAVEFORMATEX', 'DISPID_SRCERecognition',
    'DISPID_SpeechPhraseRule', 'SSFMOpenForRead', 'SpPhoneConverter',
    'SAFTADPCM_11kHzMono', 'ISpeechWaveFormatEx', 'SPGRAMMARSTATE',
    'DISPID_SVSpeak', 'SPSHT_NotOverriden', 'SAFTADPCM_22kHzMono',
    'ISpeechObjectTokens', 'eLEXTYPE_PRIVATE1', 'DISPID_SRCState',
    'DISPID_SpeechPhraseProperty', 'SPWORDPRONUNCIATION',
    'tagSPPROPERTYINFO', 'SRSEDone', 'SpeechRecognizerState',
    'SVSFIsNotXML', 'DISPID_SRRAlternates', 'SPAR_Unknown', 'SPSVerb',
    'SGRSTTWord', 'SWPKnownWordPronounceable',
    'DISPID_SADefaultFormat', 'SPPS_NotOverriden', 'DISPID_SRState',
    'DISPID_SpeechPhraseElements', 'DISPID_SOTGetStorageFileName',
    'STCInprocHandler', 'STSF_LocalAppData',
    'DISPID_SPIEnginePrivateData', 'SRTExtendableParse',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SPEAudioSizeTime',
    'ISpGrammarBuilder', 'SGLexical', 'SP_VISEME_20',
    'SpeechAudioState', 'SPSTREAMFORMATTYPE', 'DISPID_SPPConfidence',
    'SpStream', 'ISpeechPhoneConverter', 'SPEI_END_INPUT_STREAM',
    'ISpStreamFormatConverter', 'SPPS_Modifier',
    'ISpeechLexiconPronunciation', 'SpSharedRecognizer',
    'SAFTCCITT_ALaw_44kHzMono', 'ISpResourceManager',
    'DISPID_SPPChildren', 'DISPID_SLWs_NewEnum',
    'SDA_One_Trailing_Space', 'DISPID_SRRAudio', 'SAFT11kHz8BitMono',
    'DISPID_SPIElements', 'eLEXTYPE_PRIVATE16', 'ISpeechRecognizer',
    'DISPID_SLWLangId', 'DISPID_SpeechGrammarRuleState', 'SPAR_Low',
    'DISPID_SPIAudioSizeBytes', 'SGSDisabled',
    'SpeechGrammarTagWildcard', 'ISpXMLRecoResult',
    'SRERecoOtherContext', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPIDSPTSI_SelectionLength', 'SREInterference',
    'DISPID_SLAddPronunciation', 'SLTUser', 'SSFMCreateForWrite',
    'SVSFParseMask', 'SDTAudio', 'IEnumString', 'DISPID_SPEsCount',
    'SpeechRecoProfileProperties', 'SAFT12kHz16BitStereo',
    'eLEXTYPE_RESERVED4', 'DISPID_SVRate', 'DISPID_SPPsCount',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SPELexicalForm',
    'SAFT22kHz16BitMono', 'DISPID_SPEPronunciation',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SPRFirstElement',
    'SAFT48kHz8BitMono', 'DISPID_SPIStartTime', 'SASRun',
    'DISPID_SPERetainedStreamOffset', 'eLEXTYPE_RESERVED8',
    'DISPID_SGRSTransitions', 'DISPID_SRRSpeakAudio',
    'ISpeechPhraseAlternates', 'DISPID_SRCEStartStream',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SPRuleChildren',
    'DISPID_SPIAudioSizeTime', 'ISpeechFileStream', 'DISPID_SAVolume',
    'ISpeechGrammarRuleStateTransition', 'SPINTERFERENCE',
    'DISPID_SGRSTPropertyValue', 'ISpRecoResult', 'SVP_2',
    'DISPID_SRGIsPronounceable', 'SpMMAudioEnum',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SLPType',
    'DISPID_SGRInitialState', 'SP_VISEME_4', 'ISpeechPhraseProperty',
    'SAFT12kHz8BitMono', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SPEDisplayAttributes', 'DISPID_SCSBaseStream',
    'DISPID_SVAudioOutput', 'DISPID_SPARecoResult',
    'DISPID_SPEAudioStreamOffset', 'SPPARTOFSPEECH',
    'DISPID_SGRSAddSpecialTransition', 'eLEXTYPE_PRIVATE14',
    'DISPID_SAStatus', 'DISPID_SpeechCustomStream', 'SREStateChange',
    'SpeechGrammarWordType', 'ISpeechPhraseReplacements',
    'SpeechRuleState', 'DISPID_SRCEEnginePrivate',
    'SpeechRecognitionType', 'ISpeechPhraseRules', 'SDTProperty',
    'SAFTNoAssignedFormat', 'SVEViseme', 'DISPID_SRCRetainedAudio',
    'SPEI_SOUND_END', 'SRSEIsSpeaking', 'DISPID_SpeechGrammarRules',
    'eLEXTYPE_PRIVATE3', 'DISPID_SpeechMMSysAudio',
    'SDA_Two_Trailing_Spaces', 'SAFTGSM610_22kHzMono',
    'DISPID_SRCEHypothesis', 'SPSHT_EMAIL', 'DISPID_SPRulesItem',
    'DISPID_SRGReset', 'SpNullPhoneConverter',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SRCRequestedUIType',
    'ISpRecognizer', 'SP_VISEME_10', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SSTTTextBuffer', 'ISpNotifySink', 'SPVOICESTATUS',
    'SpeechBookmarkOptions', 'SREAllEvents', 'ISpeechPhraseAlternate',
    'ISpeechMemoryStream', 'SpeechLexiconType', 'SPWT_DISPLAY',
    'DISPID_SDKOpenKey', 'SAFT24kHz8BitStereo', 'SPPS_Interjection',
    'SAFTADPCM_44kHzStereo', 'SPPS_Function', 'SPBINARYGRAMMAR',
    'DISPID_SRCERecognizerStateChange', 'SRADynamic', 'ISpLexicon',
    'SASStop', 'SPDKL_CurrentUser', 'SP_VISEME_2',
    'DISPID_SPIEngineId', 'DISPID_SRGSetTextSelection',
    'DISPID_SGRAttributes', 'SpeechRecoContextState',
    'DISPIDSPTSI_SelectionOffset',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPAS_CLOSED',
    'DISPID_SOTDataKey', 'SPVISEMES', 'SPCS_ENABLED',
    'DISPID_SVPriority', 'SVEVoiceChange', 'DISPID_SPCIdToPhone',
    'DISPID_SGRSTsItem', 'DISPID_SRRSetTextFeedback', 'DISPID_SOTCId',
    'SpeechTokenShellFolder', 'DISPID_SDKDeleteValue', 'SP_VISEME_6',
    'ISpeechTextSelectionInformation', 'SPCONTEXTSTATE',
    'ISpShortcut', 'DISPID_SRCCreateGrammar', 'SPEI_UNDEFINED',
    'DISPID_SLWsItem', 'SPSSuppressWord', 'DISPID_SRStatus',
    'DISPID_SPRuleFirstElement', 'SPPS_Verb', 'SVP_18',
    'SSSPTRelativeToEnd', 'SPBOOKMARKOPTIONS', 'DISPID_SGRSRule',
    'SVSFParseSsml', 'ISpeechGrammarRules',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SLWsCount',
    'SpeechDisplayAttributes', 'DISPID_SRCVoice',
    'DISPID_SRDisplayUI', 'SGPronounciation', 'DISPID_SLWWord',
    'DISPID_SpeechLexiconWords', 'DISPID_SVAlertBoundary',
    'DISPID_SPPBRestorePhraseFromMemory', 'SRSActive',
    'SECFIgnoreCase', 'SpeechAudioProperties',
    'DISPID_SABIMinNotification', 'SVEPrivate', 'SECFEmulateResult',
    'SAFT32kHz8BitStereo', 'DISPID_SpeechMemoryStream',
    'ISpeechRecoResult', 'DISPID_SGRAddResource', 'SPPS_LMA',
    'SP_VISEME_15', 'DISPID_SPAPhraseInfo', 'SP_VISEME_18',
    'SAFT44kHz8BitStereo', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SRRAudioFormat',
    'SPEI_REQUEST_UI', 'SVP_7', 'SDTRule', 'SAFT32kHz16BitMono',
    'DISPID_SRSAudioStatus', 'SRTSMLTimeout', 'SPWORD',
    'DISPID_SRSSupportedLanguages', 'SVPOver', 'DISPID_SPPsItem',
    'SPSHORTCUTPAIR', 'SVP_20', 'DISPID_SGRName', 'SVP_15',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SBOPause',
    'IInternetSecurityMgrSite',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SDTDisplayText',
    'SPINTERFERENCE_TOOSLOW', 'ISpeechRecoResultDispatch',
    'SPINTERFERENCE_TOOQUIET', 'SPRULE', 'eWORDTYPE_ADDED',
    'SPLOADOPTIONS', 'SPEI_FALSE_RECOGNITION',
    '_ISpeechRecoContextEvents', 'SPEVENTSOURCEINFO', 'SPAUDIOSTATUS',
    'DISPID_SpeechWaveFormatEx', 'SPSHT_OTHER',
    'DISPID_SVGetAudioInputs', 'SpeechRunState',
    'DISPID_SPPEngineConfidence', 'SPPROPERTYINFO',
    'SpeechRecoEvents', 'DISPID_SLPsCount', 'SPPS_RESERVED1',
    'eLEXTYPE_USER_SHORTCUT', 'eLEXTYPE_PRIVATE19',
    'SECHighConfidence', 'DISPID_SVEStreamStart', 'SpeechAllElements',
    'SAFT48kHz16BitMono', 'DISPID_SPPParent', 'SVEBookmark',
    'eLEXTYPE_PRIVATE13', 'ISpeechPhraseProperties',
    'DISPID_SPRulesCount', 'SPPS_Noncontent', 'DISPID_SGRSTNextState',
    'ISpRecoContext2', 'DISPID_SVSCurrentStreamNumber',
    'SGDSActiveWithAutoPause', 'SpeechVisemeFeature',
    'DISPID_SpeechRecognizer', 'ISpeechLexiconWords',
    'DISPID_SOTRemoveStorageFileName', 'SAFT24kHz16BitStereo',
    'SAFT16kHz16BitStereo', 'SVSFPurgeBeforeSpeak', 'SPLEXICONTYPE',
    'ISpStreamFormat', 'SpFileStream', 'SpeechEmulationCompareFlags',
    'DISPID_SpeechPhraseElement', 'ISpeechAudio',
    'SPEI_END_SR_STREAM', 'SAFT8kHz8BitMono', 'DISPID_SGRSTType',
    'IStream', 'DISPID_SOTCategory', 'ISpeechPhraseReplacement',
    'STCInprocServer', 'ISpStream', 'SVSFParseSapi', 'SREStreamStart',
    'ISpPhraseAlt', 'SPEI_RECO_OTHER_CONTEXT', 'SPEI_RESERVED1',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRSClsidEngine',
    'SPSERIALIZEDRESULT', 'SpStreamFormatConverter',
    'SAFT12kHz8BitStereo', 'SRSInactive', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SPISaveToMemory', 'SpeechStreamFileMode',
    'SRERecognition', 'SpMemoryStream', 'DISPID_SGRsCommit',
    'DISPID_SMSAMMHandle', 'SREFalseRecognition',
    'DISPID_SpeechVoice', 'ISpeechRecoResult2', 'eLEXTYPE_RESERVED6',
    'SAFTGSM610_11kHzMono', 'DISPID_SWFEFormatTag',
    'DISPID_SVESentenceBoundary', 'SPFILEMODE', 'DISPID_SPAs_NewEnum',
    'DISPID_SFSClose', 'SPVPRI_OVER', 'SVP_11', 'SASPause',
    'SpeechSpecialTransitionType', 'SAFTGSM610_44kHzMono',
    'SPSNotOverriden', 'DISPID_SRCEFalseRecognition', 'SREAudioLevel',
    'DISPID_SRGCmdLoadFromResource', 'SITooQuiet',
    'SpTextSelectionInformation', 'SpeechCategoryVoices', 'SPSNoun',
    'IInternetSecurityManager', 'DISPID_SpeechGrammarRule',
    'SPPS_SuppressWord', 'SPEI_MAX_TTS', 'DISPID_SASNonBlockingIO',
    'DISPID_SLGetGenerationChange', 'SVESentenceBoundary',
    'SPRST_INACTIVE', 'SDTAll', 'SPFM_NUM_MODES',
    ...
    'ISpeechRecoGrammar', 'SVSFParseAutodetect',
    'DISPID_SOTGetAttribute', 'DISPID_SPIGrammarId',
    'DISPID_SDKSetBinaryValue', 'DISPID_SRCESoundStart',
    'SPFM_CREATE', 'SpeechWordType', 'DISPID_SPERequiredConfidence',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SOTMatchesAttributes', 'SPAR_High', 'DISPID_SGRAddState',
    'SSTTDictation', 'SPWF_INPUT', 'DISPID_SRGRecoContext',
    'SECNormalConfidence', 'SPEI_PHONEME', 'SPAR_Medium',
    'SpCustomStream', 'SpeechCategoryAudioIn', 'SVP_8',
    'DISPID_SLGetWords', 'SPPS_RESERVED4', 'DISPID_SpeechPhraseInfo',
    'DISPID_SRCSetAdaptationData', 'DISPID_SPIReplacements',
    'SDA_Consume_Leading_Spaces', 'DISPID_SpeechPhraseReplacement',
    'SGDisplay', 'DISPID_SPCLangId', 'DISPID_SOTDisplayUI',
    'DISPID_SPRuleParent', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SVSLastResult', 'DISPID_SRAudioInputStream',
    'SVSFNLPSpeakPunc', 'SPEI_SOUND_START', 'DISPID_SGRsFindRule',
    'DISPID_SPEs_NewEnum', 'ISpeechPhraseRule',
    'DISPID_SpeechRecoResult2', 'SPEI_HYPOTHESIS',
    'SpeechPropertyResponseSpeed', 'SAFT16kHz8BitStereo',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SASState',
    'DISPID_SGRSTsCount', 'DISPID_SpeechRecoResult',
    'DISPID_SVEAudioLevel', 'DISPID_SRCRecognizer',
    'DISPID_SRRPhraseInfo', 'SPSFunction', 'SPEI_INTERFERENCE',
    'SDTReplacement', 'eLEXTYPE_PRIVATE15', 'ISpObjectTokenCategory',
    ...
    'SPEI_VOICE_CHANGE', 'SPCT_DICTATION', 'SAFT12kHz16BitMono',
    'SPCT_COMMAND', 'SP_VISEME_12', 'ISpeechRecognizerStatus',
    'SpeechCategoryRecoProfiles', 'SPWF_SRENGINE',
    'SAFTADPCM_22kHzStereo', 'SRESoundStart', 'SGRSTTTextBuffer',
    'DISPID_SpeechObjectTokenCategory', 'eLEXTYPE_PRIVATE5',
    'SP_VISEME_7', 'ISpeechCustomStream', 'SAFT44kHz16BitMono',
    'SREStreamEnd', 'SPSUnknown', 'tagSPTEXTSELECTIONINFO', 'SVP_1',
    'ISpRecognizer2', 'LONG_PTR', 'SP_VISEME_1',
    'SWPUnknownWordPronounceable', 'SRAImport',
    'DISPID_SVIsUISupported', 'SP_VISEME_14', 'DISPID_SPPValue',
    'SPSHORTCUTPAIRLIST', 'SpeechCategoryRecognizers',
    'DISPID_SOTCSetId', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SRSetPropertyNumber', 'SPFM_OPEN_READONLY',
    'DISPID_SABIEventBias', 'SPRS_INACTIVE', 'SVEAllEvents',
    'SPEI_PHRASE_START', 'ISpeechPhraseInfo', 'SPAO_NONE', 'SVP_4',
    'DISPID_SLPSymbolic',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SpeechXMLRecoResult', 'SAFTTrueSpeech_8kHz1BitMono',
    'SAFT24kHz16BitMono', 'SpInProcRecoContext', 'tagSTATSTG',
    'SpeechWordPronounceable', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SDKEnumValues', 'DISPID_SpeechAudioStatus',
    'ISpeechPhraseInfoBuilder', 'SpeechVoiceEvents', 'SVP_9',
    'DISPID_SRCVoicePurgeEvent', 'SP_VISEME_8',
    'DISPID_SLGenerationId', 'DISPID_SpeechBaseStream',
    'DISPID_SpeechAudio', 'DISPID_SVSLastBookmarkId',
    'DISPID_SLGetPronunciations', 'SpeechAudioFormatGUIDText',
    'DISPID_SDKSetLongValue', 'SpeechTokenValueCLSID',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SLWType',
    'DISPID_SDKGetlongValue', 'SpeechInterference',
    'DISPID_SGRSTs_NewEnum', 'SPGS_ENABLED', 'SPAUDIOSTATE',
    'SP_VISEME_21', 'DISPID_SPRsCount', 'SpeechEngineProperties',
    'ISpeechObjectToken', 'SPAS_RUN', 'DISPID_SRRTStreamTime',
    'SpeechGrammarRuleStateTransitionType', 'SAFT22kHz16BitStereo',
    'SVPAlert', 'SPEI_RECO_STATE_CHANGE', 'ISpRecoGrammar',
    'Speech_StreamPos_Asap', 'SPPHRASE', 'DISPID_SRRecognizer',
    'DISPID_SGRsCount', 'SITooFast', 'SVP_19', 'DISPID_SMSADeviceId',
    'SAFT8kHz16BitStereo', 'DISPID_SDKSetStringValue',
    'DISPID_SWFEBitsPerSample', 'SLOStatic', 'SP_VISEME_19',
    'SASClosed', 'SPWT_LEXICAL', 'ISpeechResourceLoader',
    'SVSFPersistXML', 'DISPID_SOTs_NewEnum', 'SAFT16kHz8BitMono',
    'DISPID_SPEEngineConfidence', 'SVP_17', 'ISpRecoGrammar2',
    'ISequentialStream', 'SAFT11kHz8BitStereo', 'SPEI_RECOGNITION',
    'DISPID_SRRSaveToMemory', 'SPEI_VISEME', 'SAFTNonStandardFormat',
    'ISpObjectToken', 'DISPID_SABufferNotifySize', 'ISpRecoCategory',
    'DISPID_SLRemovePronunciation', 'SpeechGrammarState',
    'DISPID_SRGState', 'SpeechRuleAttributes', 'DISPID_SRRTTickCount',
    'DISPID_SVSRunningState', 'ISpObjectWithToken',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SVPause', 'SAFTText',
    'SREHypothesis', 'SFTSREngine', 'ISpeechXMLRecoResult',
    'DISPID_SRGDictationSetState', 'SPAS_STOP', 'SPFM_CREATE_ALWAYS',
    'DISPID_SRCEAudioLevel', 'SRATopLevel', 'SRAExport',
    'DISPID_SPEDisplayText', 'ISpeechLexicon', 'SVP_3', 'SPRS_ACTIVE',
    'SpeechPropertyLowConfidenceThreshold', 'SPFM_OPEN_READWRITE',
    'SpeechTokenContext', 'DISPIDSPTSI_ActiveLength',
    'SpeechVisemeType', 'SpWaveFormatEx',
    'DISPID_SREmulateRecognition', 'DISPID_SVWaitUntilDone',
    'SpeechGrammarTagDictation', 'DISPID_SLPs_NewEnum',
    'SAFT44kHz16BitStereo', 'SVP_16', 'DISPID_SVSpeakCompleteEvent',
    'SP_VISEME_13', 'DISPID_SPAsCount', 'SAFT8kHz8BitStereo',
    'ISpeechDataKey', 'SpResourceManager',
    'DISPID_SRSNumberOfActiveRules', 'SPBO_TIME_UNITS',
    'eLEXTYPE_RESERVED7', 'SWTAdded', 'DISPID_SRGCommit',
    'SPEI_RESERVED6', 'SPINTERFERENCE_NONE', 'SVSFNLPMask',
    'SPWORDTYPE', 'SpeechDataKeyLocation', 'DISPID_SOTRemove',
    'SPRECOSTATE', 'eWORDTYPE_DELETED', 'SAFT32kHz8BitMono',
    'DISPID_SVSyncronousSpeakTimeout', 'SpeechEngineConfidence',
    'SPWT_PRONUNCIATION', 'SAFTGSM610_8kHzMono',
    'SPSEMANTICERRORINFO', 'SRTReSent', 'ISpEventSink',
    'DISPID_SPRNumberOfElements', 'DISPID_SPRDisplayAttributes',
    'SPDATAKEYLOCATION', 'SpeechAudioFormatType',
    'DISPID_SpeechRecoContext', 'SPEI_START_SR_STREAM',
    'SDTLexicalForm', 'ISpeechLexiconPronunciations',
    'DISPID_SBSRead', 'DISPID_SRGCmdSetRuleIdState',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SpeechLexicon', 'DISPID_SRCResume', 'DISPID_SVSkip',
    'DISPID_SpeechPhraseBuilder', 'eLEXTYPE_PRIVATE11',
    'SSSPTRelativeToStart', 'DISPID_SRCEventInterests',
    'SPEI_TTS_AUDIO_LEVEL', 'SPXMLRESULTOPTIONS', 'SpeechDiscardType',
    'DISPID_SOTIsUISupported',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SOTCGetDataKey',
    'eLEXTYPE_LETTERTOSOUND', 'SpeechRegistryUserRoot',
    'SVF_Emphasis', 'SpLexicon', 'DISPID_SVGetVoices',
    'DISPID_SpeechPhoneConverter', 'eLEXTYPE_PRIVATE17',
    'DISPID_SpeechLexiconWord', 'ISpeechLexiconWord',
    'SpeechFormatType', 'DISPID_SPAStartElementInResult',
    'SAFTCCITT_uLaw_11kHzStereo', 'STSF_AppData',
    'DISPID_SLPPhoneIds', 'SREPhraseStart', 'SAFTDefault',
    'DISPID_SpeechPhraseProperties',
    'DISPID_SVSInputSentencePosition', 'SPCT_SLEEP', 'SGDSInactive',
    'DISPID_SVEWord', 'DISPID_SRGetRecognizers', 'SVEEndInputStream',
    'SAFTExtendedAudioFormat', 'eLEXTYPE_PRIVATE7', 'STSF_FlagCreate',
    'SVSFIsFilename', 'SGDSActiveUserDelimited', 'SAFT16kHz16BitMono',
    'DISPID_SRCEEndStream', 'ISpeechRecoResultTimes', 'SP_VISEME_9',
    'SVP_21', 'SpMMAudioOut', 'SPRULESTATE', 'SGRSTTRule',
    'SpUnCompressedLexicon', 'eLEXTYPE_PRIVATE9', 'SP_VISEME_11',
    'DISPID_SRCERequestUI', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SMSALineId', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SGSEnabled', 'SVEAudioLevel',
    'SVP_6', 'DISPID_SMSSetData', 'DISPID_SRAudioInput',
    'DISPID_SVDisplayUI', 'DISPID_SPIGetText', 'SPAS_PAUSE',
    'SSFMCreate', 'DISPID_SABufferInfo', 'SREPropertyNumChange',
    'SpObjectTokenCategory', 'ISpeechGrammarRuleState',
    'ISpeechAudioBufferInfo', 'SECFNoSpecialChars', 'SPPHRASERULE',
    'DISPID_SVEventInterests', 'SP_VISEME_5',
    'DISPID_SASFreeBufferSpace', 'ISpeechPhraseElements',
    'SpeechAudioVolume', 'ISpeechBaseStream',
    'SpeechVoiceSkipTypeSentence', 'SVSFUnusedFlags',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPSModifier', 'DISPIDSPRG',
    'SpeechAddRemoveWord', 'SAFTCCITT_uLaw_11kHzMono',
    'SECLowConfidence', 'DISPID_SWFESamplesPerSec',
    'DISPID_SRRTOffsetFromStart',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPEI_MIN_SR',
    'DISPID_SPRuleConfidence', 'DISPID_SRCBookmark',
    'eLEXTYPE_PRIVATE2', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SVEViseme', 'eLEXTYPE_RESERVED10', 'SECFIgnoreWidth',
    'SPADAPTATIONRELEVANCE', 'DISPID_SPPName', 'DISPID_SGRClear',
    'DISPID_SLWPronunciations', 'SP_VISEME_3', 'SPEI_MIN_TTS',
    'DISPID_SGRSAddRuleTransition', 'SDKLLocalMachine',
    'SRCS_Disabled', 'SINone', 'DISPID_SDKGetBinaryValue',
    'STCRemoteServer', 'DISPID_SGRsDynamic', 'DISPID_SPRsItem',
    'SGLexicalNoSpecialChars',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SRGId',
    'SPEI_TTS_BOOKMARK', 'SWPUnknownWordUnpronounceable',
    'DISPID_SOTCreateInstance', 'DISPID_SRCEPhraseStart',
    'DISPID_SGRId', 'SAFT48kHz8BitStereo', 'SPGS_DISABLED',
    'SAFT24kHz8BitMono', 'DISPID_SWFEChannels', 'SVF_Stressed',
    'SP_VISEME_17', '__MIDL_IWinTypes_0009', 'SRAORetainAudio',
    'SPEI_RESERVED5', 'SREAdaptation', 'DISPID_SPRuleId',
    'DISPID_SRRTLength', 'SpAudioFormat', 'SVP_10',
    'DISPID_SOTCDefault', 'ISpDataKey', 'DISPID_SRGetFormat',
    'SPCT_SUB_DICTATION', 'SPBO_NONE', 'SPRST_NUM_STATES',
    'SpeechUserTraining', 'DISPID_SGRs_NewEnum', 'SGRSTTEpsilon',
    'DISPID_SPPId', '_RemotableHandle', 'SAFT22kHz8BitMono',
    'DISPID_SVResume', 'DISPID_SPRules_NewEnum',
    'DISPID_SPIProperties', 'DISPID_SpeechVoiceEvent',
    'SPDKL_CurrentConfig', 'SVP_12', 'SpeechPropertyResourceUsage',
    'DISPID_SRGCmdLoadFromObject', 'SAFT8kHz16BitMono',
    'SAFT32kHz16BitStereo', 'SpNotifyTranslator', 'DISPID_SPACommit',
    'SPRECOCONTEXTSTATUS', 'SPXRO_Alternates_SML', 'SLTApp',
    'DISPID_SRCERecognitionForOtherContext', 'SRCS_Enabled',
    'SPPS_RESERVED2', 'DISPID_SPRuleNumberOfElements',
    'SPTEXTSELECTIONINFO', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SpObjectToken', 'eLEXTYPE_USER', 'SPPHRASEREPLACEMENT',
    'SpPhraseInfoBuilder', 'DISPID_SRRTimes', 'ISpAudio',
    'DISPID_SRSCurrentStreamPosition', 'SpeechTokenIdUserLexicon',
    'DISPID_SVSLastBookmark', 'ISpPhoneticAlphabetSelection',
    'SPSEMANTICFORMAT', 'DISPID_SPPNumberOfElements',
    'SPGRAMMARWORDTYPE', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SDKCreateKey', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SWFEBlockAlign', 'eLEXTYPE_PRIVATE4',
    'eLEXTYPE_PRIVATE18', 'SPAUDIOOPTIONS', 'SPINTERFERENCE_NOISE',
    'SPWAVEFORMATTYPE', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SDKLDefaultLocation', 'SPSHT_Unknown', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SAFType', 'ISpSerializeState', 'SVSFIsXML', 'SFTInput',
    'SVP_5', 'SRSActiveAlways', 'DISPID_SRGDictationLoad',
    'SpeechCategoryAppLexicons', 'SLODynamic',
    'SPDKL_DefaultLocation', 'SAFTCCITT_ALaw_11kHzStereo',
    'eLEXTYPE_APP', 'DISPID_SRIsShared', 'DISPID_SVEEnginePrivate',
    'SPCATEGORYTYPE', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SRCAudioInInterferenceStatus', 'SPRECOGNIZERSTATUS',
    'SpeechVoicePriority', 'DISPID_SLPPartOfSpeech',
    'DISPID_SpeechLexiconPronunciation', 'SITooLoud',
    'SAFT11kHz16BitStereo', 'SVPNormal', 'DISPID_SRProfile',
    'SPEI_WORD_BOUNDARY', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SOTsCount', 'DISPID_SVEVoiceChange',
    'DISPID_SpeechLexiconProns', 'SRESoundEnd',
    'DISPID_SRGetPropertyString', 'DISPID_SGRsAdd',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SVSInputWordLength',
    'DISPID_SLPLangId', 'SPBO_PAUSE', 'SVSFDefault',
    'DISPID_SRCPause', 'DISPID_SGRSTRule', 'SPSInterjection',
    'DISPID_SOTSetId', 'DISPID_SGRSTWeight',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'Speech_Max_Pron_Length',
    'SINoSignal', 'SVP_0', 'DISPID_SOTsItem', 'DISPID_SVSVisemeId',
    'SpVoice', 'SINoise', 'SVSFVoiceMask', 'ISpRecoContext',
    'DISPID_SVStatus', 'SRAInterpreter', 'DISPID_SOTGetDescription',
    'SPCT_SUB_COMMAND', 'SWTDeleted', 'SAFTADPCM_11kHzStereo',
    'SGRSTTWildcard', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SWFEExtraData', 'SPVPRIORITY', 'ISpEventSource',
    'SGRSTTDictation', 'STCLocalServer', 'SPSMF_SRGS_SAPIPROPERTIES',
    'UINT_PTR', 'DISPID_SRGSetWordSequenceData',
    'Speech_StreamPos_RealTime', 'SVEWordBoundary',
    'SDTPronunciation', 'DISPID_SRCESoundEnd', 'SPRECORESULTTIMES',
    'DISPID_SDKGetStringValue', 'Speech_Default_Weight',
    'SpeechAudioFormatGUIDWave', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SBSSeek', 'SPWORDPRONUNCIATIONLIST', 'SP_VISEME_0',
    'SRERequestUI', 'DISPID_SpeechAudioFormat', 'SAFTADPCM_8kHzMono',
    'DISPID_SRGRules', 'SPINTERFERENCE_TOOFAST', 'DISPID_SBSFormat',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SpeechDataKey',
    'eLEXTYPE_PRIVATE8', 'eLEXTYPE_RESERVED9',
    'SpeechDictationTopicSpelling', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SGRsCommitAndSave', 'SDA_No_Trailing_Space',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SVEPhoneme',
    'SpCompressedLexicon', 'DISPID_SABIBufferSize',
    'DISPID_SPANumberOfElementsInResult', 'SSFMOpenReadWrite',
    'SVEStartInputStream', 'SRADefaultToActive',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SVSPhonemeId',
    'SPLO_DYNAMIC', '_SPAUDIOSTATE', 'ISpPhoneticAlphabetConverter',
    'SITooSlow', 'SpeechStreamSeekPositionType',
    'DISPID_SRCEBookmark', 'ISpVoice', 'DISPID_SVSInputWordPosition',
    'DISPID_SOTId', 'ISpeechVoice', 'SGSExclusive', 'SPLO_STATIC',
    'DISPID_SVSInputSentenceLength', 'DISPID_SpeechVoiceStatus',
    'DISPID_SRCEPropertyNumberChange', 'SRTEmulated',
    'SPWORDPRONOUNCEABLE', 'DISPID_SVEStreamEnd',
    'SAFTCCITT_uLaw_44kHzStereo', 'Speech_Max_Word_Length',
    'DISPID_SVSpeakStream', 'SDKLCurrentConfig', 'SPEI_ADAPTATION',
    'SECFDefault', 'SPSHORTCUTTYPE', 'SPEI_RESERVED2',
    'DISPID_SPPFirstElement', 'SPINTERFERENCE_LATENCY_WARNING',
    'SGDSActive', 'DISPID_SPRText', 'SAFT48kHz16BitStereo',
    'SECFIgnoreKanaType', 'SPWORDLIST',
    'DISPID_SRSCurrentStreamNumber'
]

_check_version('1.1.14', 1653511973.379288)
